...
ic1=new ImageIcon(getClass().getResource("ic1.jpg"),"a pretty but meaningless splat");
...
for(i=0;i<=7;i++){
  ...
  Icon icon3=b[(a[i][3]-1)].getIcon();
	...
	JOptionPane.showMessageDialog(TTT1.this,"!!!Harshal won!!! click reset to play again");			 break;
                   }
             else if(icon1==ic2){ 
             ...
             if(c2.getState() == true)
                   JOptionPane.showMessageDialog(TTT1.this,"Friend won click reset to play again");
             if(c1.getState() == true)
                   JOptionPane.showMessageDialog(TTT1.this,"Computer won click reset to play again");
                break;			 
               }
         }
    }  
